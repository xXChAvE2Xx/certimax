...
<center>
    <div id="form">
    <form action="creavp.php" method="post" enctype="multipart/form-data">
      <div class="container is-max-desktop" >
        ...
        <!--<div class="field is-horizontal">
         ...
         <div class="field is-horizontal">
            <div class="field-label is-normal">  
                <label class="label" >Nombre y SWL:</label>
            </div>
            <div class="field-body">
                <div class="field">    
                    <p class="control has-icons-left">
                    <input onInput="validar()" id="input0" class="input" type="text" name="nombre" placeholder="Marcelo Ramirez M. (YCake-BoyY)"required>
                    <span class="icon is-small is-left">
      ...
      <!--fin logos-->
        <button id="submit" class="button is-success is-rounded" type="submit" value="Enviar" data-toggle="modal" data-target="#exampleModalCenter" >Descargar</button>
        </div>
        </div>
    ...
    //if(document.getElementById("input4").name.length != null)
     ...
     function validar() 
            {
               if(document.getElementById("input1").value.length != ""&&document.getElementById("input2").value.length != ""&&document.getElementById("input3").value.length != ""&&document.getElementById("input4").files[0].name != ""&&document.getElementById("input5").value.length != ""&&document.getElementById("input6").value.length != ""&&document.getElementById("input7").value.length != ""&&document.getElementById("input8").value.length != ""&&document.getElementById("input9").value.length != ""&&document.getElementById("input10").value.length != ""&&document.getElementById("input11").value.length != ""&&document.getElementById("input12").value.length != ""&&document.getElementById("input13").value.length != ""&&document.getElementById("input14").files[0].name != ""&&document.getElementById("input15").files[0].name != ""&&document.getElementById("input16").files[0].name != ""&&document.getElementById("input18").files[0].name != "")
                    {
